...
np.savetxt('./dataset/davis/corssval/index_1.txt',group_data1)
...
np.savetxt('./dataset/davis/corssval/index_0.txt',group_data0)
...
for f in trange(fold):
    ...
    np.savetxt('./dataset/davis/corssval/DTI'+str(f)+".txt",DTI)
