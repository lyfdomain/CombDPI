...
for f in range(10):
    ...
    for i in range(len(idx0)):
        ...
        score_1.append(mat_1[idx1[i][0],idx1[i][1]])
        score_2.append(mat_2[idx0[i][0],idx0[i][1]])
        score_2.append(mat_2[idx1[i][0],idx1[i][1]])
        score_3.append(mat_3[idx0[i][0],idx0[i][1]])
        score_3.append(mat_3[idx1[i][0],idx1[i][1]])
        score_4.append(mat_4[idx0[i][0],idx0[i][1]])
        score_4.append(mat_4[idx1[i][0],idx1[i][1]])
        score_5.append(mat_5[idx0[i][0],idx0[i][1]])
        score_5.append(mat_5[idx1[i][0],idx1[i][1]])
        score_6.append(mat_6[idx0[i][0],idx0[i][1]])
        score_6.append(mat_6[idx1[i][0],idx1[i][1]])
        score_7.append(mat_7[idx0[i][0],idx0[i][1]])
        score_7.append(mat_7[idx1[i][0],idx1[i][1]])
        score_8.append(mat_8[idx0[i][0],idx0[i][1]])
        score_8.append(mat_8[idx1[i][0],idx1[i][1]])
        score_true.append(mat_real[idx0[i][0],idx0[i][1]])
        score_true.append(mat_real[idx1[i][0],idx1[i][1]])
