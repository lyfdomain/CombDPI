...
np.savetxt('./dataset/drugbank/crossval/index_1.txt',group_data1)
...
np.savetxt('./dataset/drugbank/crossval/index_0.txt',group_data0)
...
for f in trange(fold):
    ...
    np.savetxt('./dataset/drugbank/crossval/DTI'+str(f)+".txt",DTI)
