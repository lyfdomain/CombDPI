...
fold=10
dr_pre=np.loadtxt('./dataset/davis/DPI_davis.txt')
simdr=np.loadtxt('./dataset/davis/SR.txt')
simpre=np.loadtxt('./dataset/davis/SP.txt')
...
np.savetxt('./dataset/davis/crossval/index_1.txt',group_data1)
...
np.savetxt('./dataset/davis/crossval/index_0.txt',group_data0)
...
for f in trange(fold):
    ...
    np.savetxt('./dataset/davis/crossval/DTI'+str(f)+".txt",DTI)
